                ...
                <div className="absolute top-56 lg:w-2/5 xl:w-1/5">
                    <form onSubmit={submit}>
                        ...
                        <div className="p-6 rounded-lg bg-white shadow-lg">
                            ...
                            <button className="w-full py-2 mt-5 bg-blue-500 rounded text-white" processing={processing}>
                                Log in
                            </button>
                        </div>

                        <p className="mt-9 text-center text-sm text-gray-700">
                            Don't have an account? <Link className="text-blue-600 hover:text-blue-500" href="/register">Sign up</Link>
                        </p>
